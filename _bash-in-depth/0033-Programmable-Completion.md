...
## Index
* [Introduction]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#introduction)
* [Programmable completion environment variables]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#programmable-completion-environment-variables)
    * [The "`COMP_CWORD`" variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-comp_cword-variable)
    * [The "`COMP_KEY`" variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-comp_key-variable)
    * [The "`COMP_LINE`" variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-comp_line-variable)
    * [The "`COMP_POINT`" variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-comp_point-variable)
    * [The "`COMP_TYPE`" variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-comp_type-variable)
    * [The "`COMP_WORDBREAKS`" variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-comp_wordbreaks-variable)
    * [The "`COMPREPLY`" variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-compreply-variable)
    * [The "`COMP_WORDS`" variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-comp_words-variable)
* [Programmable completion built-in commands]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#programmable-completion-built-in-commands)
    * [The "`compgen`" Command]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-compgen-command)
        * [Actions (the "`-A`" flag)]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#actions-the--a-flag)
        * [Function (the "`-F`" flag)]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#function-the--f-flag)
        * [Globbing (the “`-G`” flag)]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#globbing-the--g-flag)
        * [Word list (the “`-W`” flag)]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#word-list-the--w-flag)
        * [Filter out (the “`-X`” flag)]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#filter-out-the--x-flag)
        * [Suffix (the “`-S`” flag)]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#suffix-the--s-flag)
        * [Options (the “`-o`” flag)]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#options-the--o-flag)
    * [The "`complete`" Command]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#the-complete-command)
    * [How to use “`compgen`” and “`complete`” together?]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#how-to-use-compgen-and-complete-together)
        * [Adding static values to the "`COMPREPLY`" array variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#adding-static-values-to-the-compreply-array-variable)
        * [Adding static values with “`compgen`”]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#adding-static-values-with-compgen)
        * [Dynamic completion based on what has been typed so far]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#dynamic-completion-based-on-what-has-been-typed-so-far)
        * [Dynamic completion using “`COMP_CWORD`” variable]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#dynamic-completion-using-comp_cword-variable)
        * [Dynamic completion with several arguments and sub-arguments]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#dynamic-completion-with-several-arguments-and-sub-arguments)
* [Where to place the programmable completion scripts?]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#where-to-place-the-programmable-completion-scripts)
* [What happens with ZSH users?]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#what-happens-with-zsh-users)
* [Summary]({{ site.url }}//bash-in-depth/0033-Customizing-The-Prompt.html#summary)
