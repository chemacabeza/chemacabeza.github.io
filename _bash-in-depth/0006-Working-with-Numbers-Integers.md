...
* [Working with the “`let`/`declare`” builtin commands]({{ site.url }}//bash-in-depth/0006-Working-with-Numbers-Integers.html#working-with-the-“`let``declare`”-builtin-commands)
...
* [Other Integer Numbers]({{ site.url }}//bash-in-depth/0006-Working-with-Numbers-Integers.html#other-integer-numbers)
        * [Octal numbers]({{ site.url }}//bash-in-depth/0006-Working-with-Numbers-Integers.html#octal-numbers)
        * [Hexadecimal numbers]({{ site.url }}//bash-in-depth/0006-Working-with-Numbers-Integers.html#hexadecimal-numbers)
