...
2. “<code style="font-size:6">systemd</code>” is the parent process of most of the processes in the operating system. You can inspect the hierarchy of processes in the operating system with the command “<code style="font-size:6">pstree</code>”.<a href="#footnote-2-ref">&#8617;</a>
</p>
<p id="footnote-3" style="font-size:10pt">
3. We will talk about the "<code style="font-size:6">kill</code>" later in the chapter.<a href="#footnote-3-ref">&#8617;</a>
</p>
