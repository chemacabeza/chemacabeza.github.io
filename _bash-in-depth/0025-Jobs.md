...
Below, we’ll present a couple of tables listing signal numbers, their corresponding names, and brief descriptions to clarify their roles.
...
<table style="width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 1em; font-family: Arial, sans-serif; border: 1px solid #ddd;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">Equivalent to “SIGINT” but will generate a core dump<a id="footnote-5-ref" href="#footnote-5" style="font-size:x-small">[5]</a>.</td>
        </tr>
        <tr>
